...
##center-1
#x_hxk, y_hxk = x_center,YL3
#x_ldh, y_ldh = x_center,YL3
#x_mito, y_mito = x_center,YL3
#x_pyrk, y_pyrk = x_center,YL3

##hp_m_l-2
#x_hxk, y_hxk = L1 ,y_center
#x_ldh, y_ldh = L2 ,y_center
#x_mito, y_mito = x_center,YL3
#x_pyrk, y_pyrk = L1 ,y_center

##h_m_pl-3
#x_hxk, y_hxk = L1 ,y_center
#x_ldh, y_ldh = L2 ,y_center
#x_mito, y_mito = x_center, YL3
#x_pyrk, y_pyrk = L2 ,y_center

##hpm_l-4
x_hxk, y_hxk = L1,y_center
x_ldh, y_ldh = L2,y_center
x_mito, y_mito = L1,y_center
x_pyrk, y_pyrk = L1,y_center
...
T = 1000 # final time
num_step = 40000 # number of time step
dt = T / num_step

## import mesh
msh = meshio.read("starR110_n.msh")
...
radius = 70.
radiusp= 7.
area = radius**2 * np.pi - (radiusp**2 * np.pi)
...
for n in range(num_step):
    ...
    if n in [0,20,40,60,80,100,120,140,160,180,200,220,240,260,280,300,320,340,360,308,400,600,800,1000,4000,8000,12000,16000,20000,30000,39999]:
        ...
        vtkfile_glc = File('results_4n_starR110_hpm_l/glc/glc_starR110_hpm_l_%sof8000.pvd' % n)
        vtkfile_atp = File('results_4n_starR110_hpm_l/atp/atp_starR110_hpm_l_%sof8000.pvd' % n)
        vtkfile_adp = File('results_4n_starR110_hpm_l/adp/adp_starR110_hpm_l_%sof8000.pvd' % n)
        vtkfile_gly = File('results_4n_starR110_hpm_l/gly/gly_starR110_hpm_l_%sof8000.pvd' % n)
        vtkfile_pyr = File('results_4n_starR110_hpm_l/pyr/pyr_starR110_hpm_l_%sof8000.pvd' % n)
        vtkfile_lac = File('results_4n_starR110_hpm_l/lac/lac_starR110_hpm_l_%sof8000.pvd' % n)
...
np.save('./output_4n_starR110_hpm_l', np.asarray(list_of_list))
